    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 full-wid">
                <div class="service_box img-scale mb-5">
                    <figure>
                        <img src="upload/<?php echo $row['image']; ?>" alt="" style="height:250px;" />
                    </figure>
                    <div class="relative_box">
                        <h3><a href="#"><?php echo $row['client_name']; ?></a></h3>
                        <!-- <p>
                            <?php 
							 echo $row['paragraph'];
							?>
                        </p> -->
                        <a href="client-details.php?id=<?php echo $row["id"]; ?>" class="btn btn-text mt-10 mb-5">Read
                            More</a>
                    </div>
                </div>
            </div>
