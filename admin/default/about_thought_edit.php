        ...
        <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb adminx-page-breadcrumb">
                    ...
                    <li class="breadcrumb-item"aria-current="about_thought_edit">About</li>
                </ol>
            </nav>

            <div class="pb-3">
                <h2>Edit about thought</h2>
            </div>

            <?php
            $id=$_GET["id"];
            // $con=mysqli_connect("localhost","root","","nurseray_plant");
            $query=" select * from about_thought where id='$id' ";
                ...
                <div class="col-lg-12">
                    <div class="card mb-grid">
                        <div class="card-body collapse show" id="card1">
                            <form action="about_thought_update.php" method="post" enctype="multipart/form-data">
