                            ...
                            <table class="table table-actions table-striped table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="welcome_edit.php?id=<?php echo $row["id"] ?>"><button class="btn btn-primary">Edit</button></a>
                                        </td>
                                        <!-- <td>
                                            <a href="welcome_delete.php?id=<?php echo $row["id"] ?>"><button class="btn btn-primary">Delete</button></a>
                                        </td>    -->
                                    </tr>
                                    <?php
                                               }
