        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb adminx-page-breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="show_project">Project</li>
                </ol>
            </nav>
            ...
            <div class="pb-3">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="add_project"><button class="btn btn-primary">Create New</button></a>
                            ...
                            <table class="table table-actions table-striped table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_project.php?id=<?php echo $row["id"]; ?>"><button
                                                    class="btn btn-primary">Edit</button></a>
                                        </td>
                                        <td>
                                            <a href="delete_project.php?id=<?php echo $row["id"]; ?>"><button
