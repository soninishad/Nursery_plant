          ...
          <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" role="navigation">
              <ol class="breadcrumb adminx-page-breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="about_thought_add">About</a></li>
              </ol>
            </nav>

            <div class="pb-3">
              <h1>Add about thought</h1>
            </div>
              ...
              <div class="col-lg-12">
                <div class="card mb-grid">
                  ...
                  <div class="card-body collapse show" id="card1">
                    <form action="about_thought_insert.php" method="post"  enctype="multipart/form-data">
