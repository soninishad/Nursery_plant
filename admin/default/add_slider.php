          ...
          <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" role="navigation">
              <ol class="breadcrumb adminx-page-breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="add_slider">Slider</a></li>
              </ol>
            </nav>
                  ...
                  <div class="card-body collapse show" id="card1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="sub_heading"  class="form-control"  aria-describedby="sub_heading" placeholder="Enter sub heading">
                      </div>
